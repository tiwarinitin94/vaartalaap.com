        ...
        $.post('' + url_vrt + 'gallery_area/get_user_news/helloalkddaklfjakldjaksdjaakdjdakljdkjdksjkjakjdksjdakjssjdksdjsa', { 'last_id': post_id_f }, function (o) {
            if (o == "") {
                ...
                for (var i = 0; i < o.length; i++) {
                    data_pic_value(o[i].id, o[i].added_by, o[i].date_added, o[i].body, o[i].user_posted_to, o[i].if_shared, 0);
...
var data_pic;
//-----------------------------------------image creating
function data_pic_value(id, added_by, date_added, body, user_posted_to, if_shared, show) {
    ...
    if (if_shared) {
        ...
        if (document.getElementById("post-image" + id + "") == null) {
            ...
            if (document.getElementById("newsfeed_home_friends") == null) {
                console.log("post-ima");

            } else {
                console.log("post-image" + added_by);
            ...
            $('#' + post_id).append("<div class='status' id='status"
                ...
                + id +
                "' class='post-image_work'></div><div class='posted_by'><a href='#'>"
                + added_by +
